...
public class GlobalExceptionHandler {
    ...
    protected ApiError cartNotFoundException(CartNotFoundException ex,  WebRequest request) {
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    protected ApiError productException(ProductException ex,  WebRequest request) {
    ...
    protected ApiError generalServerException(Exception ex,  WebRequest request) {
